# Source https://github.com/crytic/fuzz-utils/blob/45092386bc3965ab978ee5e917b50c658638611a/fuzz_utils/utils/encoding.py#L45-L86
...
if __name__ == "__main__":
    try:
        ...
        if input_str:
            # Always pass True for isBytes when processing Echidna output
            result = parse_echidna_byte_string(input_str, True)
            print(result)
